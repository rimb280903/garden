...
<html lang="en">
	<head>
		...
		<title>Comparateur En ligne</title>
        ...
        <link rel="stylesheet" href="{{asset('public/admin/plugins/dropzone/dropzone.css')}}">
        <link rel="stylesheet" href="{{asset('public/admin/plugins/summernote/summernote.min.css')}}">
        <!-- Include the Dropzone CSS and JS files from a CDN -->
	...
	<body class="hold-transition sidebar-mini">
		...
		<div class="wrapper">
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; 2024 Comparateur En Ligne All rights reserved.
			</footer>
